...
const Home: NextPage = () => {
  ...
  const editionDrop = useContract("0x2f5c04832B9cDaD50472A2Ce95895D0FDF0610a8", "edition-drop").contract;
  const token = useContract("0xa5D8aAFB52093B79d83007ee25299f9162266e3B", "token").contract;
  // 投票コントラクトの初期化
  const vote = useContract("0x0e16A7c6F95E6eBbe4afBB5276e70d1553a2eCad", "vote").contract;
